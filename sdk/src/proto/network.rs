...
/// The request for a nonce. Should be called before signing a message to get the correct nonce for
/// the account.
...
pub struct GetNonceResponse {
    /// The nonce for the given address. Should be signed along with the rest of the message.
    #[prost(uint64, tag = "1")]
    pub nonce: u64,
}
/// The request to get a proof status by a given proof.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct CreateProofRequest {
    ...
    /// for. Any time after this, provers will no longer continue to attempt to fulfill.
    #[prost(uint64, tag = "2")]
    pub deadline: u64,
...
/// The response for creating a proof, the first step in requesting a proof.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CreateProofResponse {
    ...
    #[prost(string, tag = "1")]
    pub proof_id: ::prost::alloc::string::String,
    /// The url to upload the elf to.
    #[prost(string, tag = "2")]
    pub program_url: ::prost::alloc::string::String,
    /// The url to upload the stdin to.
    #[prost(string, tag = "3")]
    pub stdin_url: ::prost::alloc::string::String,
}
/// The request to submit a proof, the second step in requesting a proof. Should only be called after
/// the program and stdin have been uploaded.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// The request to claim a proof, which agrees to fulfill the proof by the deadline.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// The response for claiming a proof, giving identifiers for the location to retrieve the program
/// and stdin, as well as the the location to upload the proof.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// The request to fulfill a proof. Should only be called after the proof has been uploaded. Only
/// callable by the prover that claimed the proof previously.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct FulfillProofResponse {
    /// The amount of seconds between proof claim and fulfillment.
    #[prost(uint64, tag = "1")]
    pub proving_seconds: u64,
}
/// The request to relay a proof through the NetworkGateway on a given chain. Should only be called
/// after a proof has been fulfilled.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RelayProofRequest {
    ...
    /// The address of the callback to call after the proof was verified by the verifier.
...
/// The request to get the status of relay request.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// The response for getting the status of relay request transaction.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetRelayStatusResponse {
    ...
    /// The simulation url, only present if the transction failed.
    #[prost(string, tag = "3")]
...
pub enum ProofStatus {
    /// Unspecified status / invalid status.
    ProofUnspecifiedStatus = 0,
    /// The proof request has been created but not submitted.
    ProofPreparing = 1,
    ...
    ProofClaimed = 3,
    /// The proof request has been fulfilled.
    ProofFulfilled = 4,
    /// The proof request failed and will need to be re-submitted.
    ProofFailed = 5,
}
impl ProofStatus {
...
pub enum TransactionStatus {
    ...
    /// The transaction has been broadcasted to the requested chain.
    TransactionBroadcasted = 2,
    /// The transaction was never confirmed to be mined.
    TransactionTimedout = 3,
    /// The transaction failed to be broadcasted, likely due to a revert in simulation.
    TransactionFailed = 4,
